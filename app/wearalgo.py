...
def userinput():
    ...
    #create df
    userinputdump = pd.read_csv('../WEAR_Notebooks/data/userinputdump.csv')
    ...
    if st.button("What should I wear?"):    
        ...
        userinputdump.to_csv('../WEAR_Notebooks/data/userinputdump.csv',index = False)
        print(userinfo)
       ...
       # return userid
        ...
        #load dataset
        geo = pd.read_csv('../WEAR_Notebooks/data/towns_latlong.csv', sep = ';')
        ...
        weatherdump = pd.read_csv('../WEAR_Notebooks/data/weatherdump.csv')
        ...
        weatherdump = weatherdump.reset_index(drop=True)
        weatherdump.to_csv('../WEAR_Notebooks/data/weatherdump.csv', index = False)
        ...
        #with mytemp
        usercleanmytemp = pd.read_csv('../WEAR_Notebooks/data/usercleanmytemp.csv')
        ...
        userdumpmytemp.to_csv('../WEAR_Notebooks/data/usercleanmytemp.csv', index = False)

        #without mytemp
        usercleanwnotemp = pd.read_csv('../WEAR_Notebooks/data/usercleannotemp.csv')
        ...
        userdumpnotemp.to_csv('../WEAR_Notebooks/data/usercleannotemp.csv', index = False)


        #############RECOMMEND CLOTHES#############

        #import df
        clothes = pd.read_excel('../WEAR_Notebooks/data/ClothesTemp.xlsx')
